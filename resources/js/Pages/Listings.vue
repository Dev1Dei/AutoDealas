<template>
  ...
  <car-listing v-for="listing in searchResults ? searchResults : this.listings" :key="listing.id" :listing="listing" :photo="listing.photo" :fuelType="listing.fuelType" :model="listing.model" :miles="listing.miles" :make="listing.make" :engine="listing.engine"
