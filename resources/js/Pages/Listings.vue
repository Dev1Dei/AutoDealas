<template>
  ...
  <car-listing v-for="listing in searchResults.length == 0 ? this.listings : searchResults" :key="listing.id" :fuelType="listing.fuelType" :model="listing.model" :make="listing.make" :engine="listing.engine"
